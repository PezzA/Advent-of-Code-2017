...
// PuzzleInput returns puzzle input for day02
...
// PartOne returns the solution for day 2 part one
func PartOne(input string) (string, error) {
	return getKeyCode(input, Point{2, 2}, getKeyPad()), nil
}

// PartTwo returns the solution for day 2 part one
func PartTwo(input string) (string, error) {
	return getKeyCode(input, Point{3, 3}, getStarPad()), nil
}
